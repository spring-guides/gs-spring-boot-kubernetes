...
This guide walks you through the process of deploying a Spring Boot application on https://kubernetes.io[Kubernetes]. You can follow a tutorial on https://www.katacoda.com/springguides/scenarios/complete[Katacoda] covering eactly the same content, in which case all the code will be running in the cloud from your browser, or you can create your own cluster and install all the tools you need locally.
