...
Source code for this guide is in [Github](https://github.com/spring-guides/gs-spring-boot-kubernetes/tree/master/install-kubernetes). It is deployed in [Katacoda](https://www.katacoda.com/springguides/scenarios/install-kubernetes) where you can run the code interactively in your browser.